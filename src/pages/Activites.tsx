      ...
      <div className="container mx-auto px-4 py-16">
        {filtered.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filtered.map((act) => (
              <div key={act.slug} className="bg-card rounded-2xl overflow-hidden border border-border group hover:shadow-lg transition-shadow">
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Link to={`/activites/${act.slug}`} className="text-xs text-primary hover:underline font-medium">
                        Détails
                      </Link>
                      <button onClick={() => setSelectedActivity(act)} className="flex items-center gap-1 bg-primary text-primary-foreground px-4 py-2 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity">
